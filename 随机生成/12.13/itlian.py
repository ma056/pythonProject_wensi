...
def airline_tel_train_number():
    ...
    return ["Airline"] * 3000, ["Airline"] * 7000, ["LettersOnly"] * 3000, ["LettersOnly"] * 7000, \
           ...
           tel_train_number_list[0:3000], tel_train_number_list[3001:10001]
...
def fast_confirmation_number():
    ...
    number = 10001 - len(confirmation_number_list)
    ...
    return ["Fastfood"] * 3000, ["Fastfood"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "Confirmation number"] * 3000, ["Confirmation number"] * 7000, confirmation_number_list[0:3000], \
           confirmation_number_list[3001:10001]
...
def media_wide_band():
    ...
    # print(refund_num_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, \
           ["NumbersOnly"] * 7000, ["Wide band type"] * 3000, ["Wide band type"] * 7000, wide_band_list[0:3000], \
           wide_band_list[3001:10001]
...
def media_email_address1():
    ...
    # print(refund_num_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["LettersOnly"] * 3000, \
           ["LettersOnly"] * 7000, ["Email Address"] * 3000, ["Email Address"] * 7000, email_address_list1[0:3000],\
           email_address_list1[3001:10001]
...
def media_psw():
    ...
    # print(refund_num_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["LettersOnly"] * 3000, \
           ["LettersOnly"] * 7000,["password"] * 3000, ["password"] * 7000, psw_list[0:3000], psw_list[3001:10001]
...
def media_psw1():
    ...
    # print(refund_num_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, \
           ["NumbersOnly"] * 7000, ["password"] * 3000, ["password"] * 7000, psw_list1[0:3000], psw_list1[3001:10001]
