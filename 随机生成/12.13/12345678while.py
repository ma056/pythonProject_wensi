...
def aviation_flight_number():
    start_num = ["3U", "NS", "8C", "CA", "SC", "MF", "EU", "ZH", "VD", "FM", "KN", "MU", "HU", "CN", "8L", "PN", "GS",
                 "HO", "BK", "G5", "9C", "JD"]
    list1 = []
    while len(list1) <= 10000:
    # for i in range(0, 13000):
        random_pn = random.choice(start_num)
        random_num = str(random.randint(0, 9999)).zfill(3)
        random_num1 = str(random.randint(0, 9999)).zfill(4)
        phone_num1 = f"{random_pn}{random_num}"
        phone_num2 = f"{random_pn}{random_num1}"
        list1.append(phone_num1)
        list1.append(phone_num2)
        list1 = list(set(list1))
    # print(flight_number_list)
    return ["Airline"] * 3000, ["Airline"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "航班号"] * 3000, ["航班号"] * 7000, list1[0:3000], list1[3000:10000]
...
def aviation_order_no():
    ...
    return ["Airline"] * 3000, ["Airline"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "机票订单编号"] * 3000, ["机票订单编号"] * 7000, order_no[0:3000], order_no[3000:10000]
...
def aviation_service_tel_num():
    ...
    service_tel_num = []
    while len(service_tel_num) <= 10000:
    # for i in range(0, 18000):
        ...
        if new_random_pn in ["400", "021", "028", "010"]:
            ...
            service_tel_num.append(phone_num)
        service_tel_num = list(set(service_tel_num))
    # print(res_service_tel_num_list)
    return ["Airline"] * 3000, ["Airline"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "客服电话"] * 3000, ["客服电话"] * 7000, service_tel_num[0:3000], service_tel_num[3000:10000]
...
def fast_food_order_no():
    ...
    return ["Fastfood"] * 3000, ["Fastfood"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, ["订单编号"] * 3000, \
           ["订单编号"] * 7000, order_no[0:3000], order_no[3000:10000]


# 订单编号 仅数字 13-19位
def fast_food_tel_num():
    tel_num = []
    while len(tel_num) < 10000:
    # for i in range(0, 12000):
        random_num = str(random.randint(1000000000000, 9999999999999999999))
        phone_num = "{}{:0<8}".format(187, random_num)
        tel_num.append(phone_num)
        tel_num = list(set(tel_num))
    # print(tel_num_list)
    return ["Fastfood"] * 3000, ["Fastfood"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, \
           ["订单编号"] * 3000, ["订单编号"] * 7000, tel_num[0:3000], tel_num[3000:10000]


# 运单号 可变4位
def fast_food_waybill_no():
    waybill_no = []
    while len(waybill_no) < 10000:
    # for i in range(0, 12000):
        random_num = str(random.randint(1000, 999999))
        phone_num = f'909{random_num}'
        waybill_no.append(phone_num)
        waybill_no = list(set(waybill_no))
    # print(waybill_no_list)
    return ["Fastfood"] * 3000, ["Fastfood"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "运单号"] * 3000, ["运单号"] * 7000, waybill_no[0:3000], waybill_no[3000:10000]


# 取件码 数字 四位以上
def fast_food_pick_code():
    pick_code = []
    while len(pick_code) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(1000, 999999))
        pick_code.append(random_num)
        pick_code = list(set(pick_code))
    # print(pick_codeo_list)
    return ["Fastfood"] * 3000, ["Fastfood"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "取件码"] * 3000, ["取件码"] * 7000, pick_code[0:3000], pick_code[3000:10000]
...
def finance_credit_code():
    ...
    # for i in range(0, 11000):
        ...
        credit_code = list(set(credit_code))
    # print(order_no_list)
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "统一社会信用代码"] * 3000, ["统一社会信用代码"] * 7000, credit_code[0:3000], credit_code[3000:10000]
...
def finance_serial_number():
    ...
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "证照编号"] * 3000, ["证照编号"] * 7000, serial_number[0:3000], serial_number[3000:10000]
...
def finance_id_number():
    ...
    # for i in range(0, 11000):
        ...
        id_number = list(set(id_number))
    # print(id_number_list)
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "身份证号"] * 3000, ["身份证号"] * 7000, id_number[0:3000], id_number[3000:10000]
...
def finance_id_number1():
    serial_number1 = []
    while len(serial_number1) < 10000:
    # for i in range(0, 11000):
        num1 = random.choice(
            [11, 12, 13, 14, 15, 21, 22, 23, 31, 32, 33, 34, 35, 36, 37, 41, 42, 43, 44, 45, 46, 50, 51, 52, 53, 54, 61,
             62, 63, 64, 65])
        ...
        serial_number1 = list(set(serial_number1))
    # print(id_number_list1)
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "身份证号"] * 3000, ["身份证号"] * 7000, serial_number1[0:3000], serial_number1[3000:10000]
...
def finance_bank_card():
    ...
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "银行卡/信用卡号"] * 3000, ["银行卡/信用卡号"] * 7000, bank_card[0:3000], bank_card[3000:10000]
...
def finance_contract_no():
    ...
    # print(bank_card_list)
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "合同编号"] * 3000, ["合同编号"] * 7000, bank_card[0:3000], bank_card[3000:10000]


# 项目编号1 4位以上 SDTASJ2017-0910-00 2017-0910需要是合理的日期时间，范围可设为1940-0101 - 2022-1231
def finance_item_no():
    item_no = []
    while len(item_no) < 10000:
    # for i in range(0, 12000):
        num1 = ''.join(random.sample(string.ascii_uppercase, 2))
        year = str(random.randint(1940, 2020))
        month = str(random.randint(1, 12))
        ...
        item_no.append(num)
        item_no = list(set(item_no))
    # print(item_no_list)
    return ["Finance"] * 3000, ["Finance"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, [
        "项目编号"] * 3000, ["项目编号"] * 7000, item_no[0:3000], item_no[3000:10000]
...
def healthcare_batch_number():
    ...
    # for i in range(0, 13000):
        ...
        batch_number = list(set(batch_number))
    # print(batch_number_list)
    return ["HealthCare"] * 3000, ["HealthCare"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "生产批号"] * 3000, ["生产批号"] * 7000, batch_number[0:3000], batch_number[3000:10000]


# 收据单号 NumbersOnly  7位 1147152
def healthcare_receipt_no():
    receipt_no = []
    while len(receipt_no) <= 10000:
    # for i in range(0, 11000):
        num = str(random.randint(1000000, 9999999)).zfill(2)
        receipt_no.append(num)
        receipt_no = list(set(receipt_no))
    # print(receipt_no_list)
    return ["HealthCare"] * 3000, ["HealthCare"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "收据单号"] * 3000, ["收据单号"] * 7000, receipt_no[0:3000], receipt_no[3000:10000]
...
def insurance_serial_number():
    ...
    # print(serial_number_list)
    return ["Insurance"] * 3000, ["Insurance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "流水号"] * 3000, ["流水号"] * 7000, serial_number[0:3000], serial_number[3000:10000]


# 社保卡账号 NumbersOnly  10位 0007033382
def insurance_social_security_card_account():
    social_card = []
    while len(social_card) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(1000000000, 9999999999))
        social_card.append(random_num)
        social_card = list(set(social_card))
    # print(social_card_list)
    return ["Insurance"] * 3000, ["Insurance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "社保卡账号"] * 3000, ["社保卡账号"] * 7000, social_card[0:3000], social_card[3000:10000]
...
def insurance_occupational_injury_certificate_no():
    ...
    # for i in range(0, 11000):
        ...
        injury_no = list(set(injury_no))
    # print(injury_no_list)
    return ["Insurance"] * 3000, ["Insurance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "工伤认证号"] * 3000, ["工伤认证号"] * 7000, injury_no[0:3000], injury_no[3000:10000]
...
def insurance_fax_no():
    ...
    # for i in range(0, 11000):
        ...
        fax_no = list(set(fax_no))
    # print(fax_no_list)
    return ["Insurance"] * 3000, ["Insurance"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "传真号"] * 3000, ["传真号"] * 7000, fax_no[0:3000], fax_no[3000:10000]
...
def medial_order_no():
    ...
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "订单编号"] * 3000, ["订单编号"] * 7000, order_no[0:3000], order_no[3000:10000]


# 退款编号 4位以上
def medial_refund_no():
    refund_no = []
    while len(refund_no) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(1000, 999999))
        refund_no.append(random_num)
        refund_no = list(set(refund_no))
    # print(order_no_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "退款编号"] * 3000, ["退款编号"] * 7000, refund_no[0:3000], refund_no[3000:10000]
...
def medial_residual_flow():
    ...
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, \
           ["剩余流量"] * 3000, ["剩余流量"] * 7000, residual_flow[0:3000], residual_flow[3000:10000]


# 宽带号码 4位以上 NumbersOnly 241010107651
def medial_broadband_number():
    broadband_number = []
    while len(broadband_number) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(1000, 999999))
        broadband_number.append(random_num)
        broadband_number = list(set(broadband_number))
    # print(broadband_number_list)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "宽带号码"] * 3000, ["宽带号码"] * 7000, broadband_number[0:3000], broadband_number[3000:10000]
...
def medial_psw():
    ...
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["LettersOnly"] * 3000, [
        "LettersOnly"] * 7000, ["密码"] * 3000, ["密码"] * 7000, psw[0:3000], psw[3000:10000]
...
def medial_psw1():
    ...
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, [
        "NumbersOnly"] * 7000, ["密码"] * 3000, ["密码"] * 7000, psw1[0:3000], psw1[3000:10000]
...
def medial_ver_code():
    ...
    # print(psw_list1)
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["NumbersOnly"] * 3000, [
        "NumbersOnly"] * 7000, ["验证码"] * 3000, ["验证码"] * 7000, ver_code[0:3000], ver_code[3000:10000]


# 邮箱地址  @前4-10位 LettersOnly zhangsan@sina.com, wangwu@outlook.com    @sina.com, @sohu.com, @outlook.com
def medial_email():
    aviation_name = []
    while len(aviation_name) < 10000:
    # for i1 in range(12000):
        ...
        aviation_name = list(set(aviation_name))
    return ["MediaInternetTelecom"] * 3000, ["MediaInternetTelecom"] * 7000, ["LettersOnly"] * 3000, [
        "LettersOnly"] * 7000, ["邮箱地址"] * 3000, ["邮箱地址"] * 7000, aviation_name[0:3000], aviation_name[3000:10000]
...
def retail_commodity_code():
    ...
    # for i in range(0, 10000):
        ...
        commodity_code = list(set(commodity_code))
    # print(psw_list)
    return ["Retail"] * 3000, ["Retail"] * 7000, ["LettersOnly"] * 3000, ["LettersOnly"] * 7000, \
           ["商品编码/ID"] * 3000, ["商品编码/ID"] * 7000, commodity_code[0:3000], commodity_code[3000:10000]


# 商品编码/ID NumbersOnly   4位以上
def retail_commodity_code1():
    commodity_code1 = []
    while len(commodity_code1) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(1000, 9999999))
        commodity_code1.append(random_num)
        commodity_code1 = list(set(commodity_code1))
    # print(psw_list)
    return ["Retail"] * 3000, ["Retail"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, \
           ["商品编码/ID"] * 3000, ["商品编码/ID"] * 7000, commodity_code1[0:3000], commodity_code1[3000:10000]


# 车型        NumbersAndLetters   CAF7230A    字母位置固定大写
def retail_car_type():
    car_type = []
    while len(car_type) < 10000:
    # for i in range(0, 11000):
        ...
        car_type = list(set(car_type))
    # print(psw_list)
    return ["Retail"] * 3000, ["Retail"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, \
           ["车型"] * 3000, ["车型"] * 7000, car_type[0:3000], car_type[3000:10000]
...
def retail_vin():
    ...
    # print(psw_list)
    return ["Retail"] * 3000, ["Retail"] * 7000, ["NumbersAndLetters"] * 3000, ["NumbersAndLetters"] * 7000, \
           ["VIN码"] * 3000, ["VIN码"] * 7000, vin[0:3000], vin[3000:10000]
...
def travel_reservation_no():
    reservation_no = []
    while len(reservation_no) < 10000:
    # for i in range(0, 11000):
        ...
        reservation_no = list(set(reservation_no))
    # print(fax_no_list)
    return ["Travel"] * 3000, ["Travel"] * 7000, ["LettersOnly"] * 3000, ["LettersOnly"] * 7000, [
        "预定号"] * 3000, ["预定号"] * 7000, reservation_no[0:3000], reservation_no[3000:10000]


# 预定号 4位以上 NumbersOnly  282******
def travel_reservation_no1():
    reservation_no1 = []
    while len(reservation_no1) < 10000:
    # for i in range(0, 11000):
        random_num = str(random.randint(0, 9999999)).zfill(4)
        reservation_no1.append(random_num)
        reservation_no1 = list(set(reservation_no1))
    # print(fax_no_list)
    return ["Travel"] * 3000, ["Travel"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "预定号"] * 3000, ["预定号"] * 7000, reservation_no1[0:3000], reservation_no1[3000:10000]
...
def travel_room_num():
    ...
    # print(fax_no_list)
    return ["Travel"] * 3000, ["Travel"] * 7000, ["NumbersOnly"] * 3000, ["NumbersOnly"] * 7000, [
        "房间号"] * 3000, ["房间号"] * 7000, room_num[0:3000], room_num[3000:10000]
