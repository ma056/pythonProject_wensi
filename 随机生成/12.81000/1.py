...
#     xing = ["ZHAO","QIAN","SUN","LI","ZHOU","WU","ZHENG","WANG","FENG","CHU","WEI","JIANG","SHEN","HAN","YANG","ZHU","QIN","YOU","XU","HE","SHI","ZHANG","KONG","CAO","YAN","HUA","WEI","JIANG","TAO","MA","CHEN"]
#     # ming = '豫章故郡洪都新府星分翼轸地接衡庐襟三江而带五湖'
#     ming = ["YU","ZHANG","GU","JUN","HONG","DOU","XIN","FU","XING","FEN","YI","ZHEN","DI","JIE","HENG","LU","JIN","SAN","JIANG","ER","DAI","WU","HU","SI","YI"]
